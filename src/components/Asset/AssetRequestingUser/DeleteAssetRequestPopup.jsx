      ...
      <div className="asset-popup-container">
        <div className="asset-popup-header">
          <div className="asset-popup-header-content">
            ...
            <div style={{ flex: 1 }}>
              ...
              <p className="asset-popup-subtitle">This action cannot be undone</p>
            </div>
          </div>
        ...
        <div style={{ marginBottom: '24px' }}>
          <div className="asset-delete-warning-box">
            ...
            <div style={{ marginTop: '16px', padding: '16px', backgroundColor: 'var(--asset-input-bg)', borderRadius: '8px', border: '1px solid var(--asset-input-border)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                <span style={{ fontWeight: '600', color: 'var(--asset-popup-text-secondary)' }}>Asset:</span>
                <span style={{ color: 'var(--asset-popup-text-primary)' }}>{asset.asset_name}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                <span style={{ fontWeight: '600', color: 'var(--asset-popup-text-secondary)' }}>Status:</span>
                <span style={{ color: 'var(--asset-popup-text-primary)' }}>{asset.status}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <span style={{ fontWeight: '600', color: 'var(--asset-popup-text-secondary)' }}>Quantity:</span>
                <span style={{ color: 'var(--asset-popup-text-primary)' }}>{asset.quantity}</span>
              </div>
            </div>
          </div>
        </div>
