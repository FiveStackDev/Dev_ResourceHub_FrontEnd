...
const EmailVerificationStep = ({
  ...
  const deleteOrganization = async () => {
    ...
    try {
      ...
      if (!userId || !orgId) {
        throw new Error(
          'User or Organization ID not found. Please log in again.',
        );
      }
    ...
    return (
      <div className="step-container">
        <div style={{ textAlign: 'center' }}>
          ...
          >
            The organization and all associated data have been permanently
            removed. You will be redirected to the login page shortly.
          </p>
          <div
            style={{
          ...
          >
            <strong>Thank you for using ResourceHub.</strong>
            <br />
            If you need to create a new organization in the future, please
  ...
  return (
    <div className="step-container">
      ...
      <div className="step-content">
        ...
        >
          ...
          >
            <AlertTriangle
              size={20}
              style={{ color: 'var(--settings-danger-text)' }}
            />
            <h4
              style={{
          ...
          >
            ...
            <strong>
              {' '}
              ALL DATA WILL BE IMMEDIATELY AND PERMANENTLY DESTROYED
            </strong>
        ...
        {timeLeft === 0 && (
          ...
          >
            <strong>Verification code has expired.</strong>
            <br />
        ...
        >
          <strong>Check your email:</strong> The verification code was sent to
          your organization email address. Check your inbox and spam folder. The
          code is valid for 5 minutes for security purposes.
        </div>
      </div>
      ...
      <div className="step-actions">
        ...
        {timeLeft === 0 ? (
          <button className="step-button secondary" onClick={onReset}>
            <RefreshCw size={18} />
            Start Over
          </button>
        ) : (
          <button
            ...
            disabled={
              isDeleting || verificationCode.length !== 6 || timeLeft === 0
            }
          >
            {isDeleting ? (
              <>
