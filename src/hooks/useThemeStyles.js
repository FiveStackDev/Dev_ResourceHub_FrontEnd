  ...
  return useMemo(() => {
    ...
    const updateCSSVariables = () => {
      ...
      if (isDark) {
        ...
        root.style.setProperty('--calendar-popup-text-secondary', 'rgba(255, 255, 255, 0.7)');
        ...
        root.style.setProperty('--calendar-card-shadow-hover', 'rgba(0, 0, 0, 0.3)');
        root.style.setProperty('--calendar-card-border', '#374151');
        root.style.setProperty('--calendar-card-border-hover', '#4b5563');
        root.style.setProperty('--calendar-button-primary-bg', 'rgba(34, 197, 94, 0.15)');
        root.style.setProperty('--calendar-button-primary-border', '#22c55e');
        root.style.setProperty('--calendar-button-primary-text', '#4ade80');
        root.style.setProperty('--calendar-button-primary-hover-bg', 'rgba(34, 197, 94, 0.25)');
        root.style.setProperty('--calendar-button-primary-hover-border', '#4ade80');
        root.style.setProperty('--calendar-button-primary-hover-text', '#86efac');
        root.style.setProperty('--calendar-button-secondary-bg', 'rgba(59, 130, 246, 0.15)');
        ...
        root.style.setProperty('--calendar-button-secondary-hover-bg', 'rgba(59, 130, 246, 0.25)');
        root.style.setProperty('--calendar-button-secondary-hover-border', '#60a5fa');
        root.style.setProperty('--calendar-button-secondary-hover-text', '#93c5fd');
        root.style.setProperty('--calendar-delete-warning-bg-primary', '#2a2a3e');
        root.style.setProperty('--calendar-delete-warning-bg-secondary', '#374151');
        ...
        root.style.setProperty('--calendar-delete-error-bg-secondary', '#4a2222');
        ...
        root.style.setProperty('--asset-popup-text-secondary', 'rgba(255, 255, 255, 0.7)');
        ...
        root.style.setProperty('--asset-card-shadow-hover', 'rgba(0, 0, 0, 0.3)');
        root.style.setProperty('--asset-card-border', '#374151');
        root.style.setProperty('--asset-card-border-hover', '#4b5563');
        root.style.setProperty('--asset-button-primary-bg', 'rgba(59, 130, 246, 0.15)');
        root.style.setProperty('--asset-button-primary-border', '#3b82f6');
        root.style.setProperty('--asset-button-primary-text', '#60a5fa');
        root.style.setProperty('--asset-button-primary-hover-bg', 'rgba(59, 130, 246, 0.25)');
        root.style.setProperty('--asset-button-primary-hover-border', '#60a5fa');
        root.style.setProperty('--asset-button-primary-hover-text', '#93c5fd');
        root.style.setProperty('--asset-button-secondary-bg', 'rgba(99, 102, 241, 0.15)');
        root.style.setProperty('--asset-button-secondary-border', '#6366f1');
        root.style.setProperty('--asset-button-secondary-text', '#a5b4fc');
        root.style.setProperty('--asset-button-secondary-hover-bg', 'rgba(99, 102, 241, 0.25)');
        root.style.setProperty('--asset-button-secondary-hover-border', '#a5b4fc');
        root.style.setProperty('--asset-button-secondary-hover-text', '#c7d2fe');
        root.style.setProperty('--asset-delete-warning-bg-primary', '#2a2a3e');
        root.style.setProperty('--asset-delete-warning-bg-secondary', '#374151');
        ...
        root.style.setProperty('--settings-popup-text-secondary', 'rgba(255, 255, 255, 0.7)');
        ...
        root.style.setProperty('--settings-button-primary-bg', 'rgba(59, 130, 246, 0.15)');
        ...
        root.style.setProperty('--calendar-popup-shadow', 'rgba(0, 0, 0, 0.15)');
        ...
        root.style.setProperty('--calendar-card-shadow-hover', 'rgba(0, 0, 0, 0.12)');
        root.style.setProperty('--calendar-card-border', '#e2e8f0');
        root.style.setProperty('--calendar-card-border-hover', '#cbd5e1');
        root.style.setProperty('--calendar-button-primary-bg', 'rgba(34, 197, 94, 0.05)');
        root.style.setProperty('--calendar-button-primary-border', '#22c55e');
        root.style.setProperty('--calendar-button-primary-text', '#22c55e');
        root.style.setProperty('--calendar-button-primary-hover-bg', 'rgba(34, 197, 94, 0.1)');
        root.style.setProperty('--calendar-button-primary-hover-border', '#16a34a');
        root.style.setProperty('--calendar-button-primary-hover-text', '#16a34a');
        root.style.setProperty('--calendar-button-secondary-bg', 'rgba(59, 130, 246, 0.05)');
        root.style.setProperty('--calendar-button-secondary-border', '#3b82f6');
        root.style.setProperty('--calendar-button-secondary-text', '#3b82f6');
        root.style.setProperty('--calendar-button-secondary-hover-bg', 'rgba(59, 130, 246, 0.1)');
        root.style.setProperty('--calendar-button-secondary-hover-border', '#2563eb');
        root.style.setProperty('--calendar-button-secondary-hover-text', '#2563eb');
        root.style.setProperty('--calendar-delete-warning-bg-primary', '#f8fafc');
        root.style.setProperty('--calendar-delete-warning-bg-secondary', '#f1f5f9');
        ...
        root.style.setProperty('--calendar-delete-error-bg-secondary', '#fee2e2');
        ...
        root.style.setProperty('--asset-card-shadow-hover', 'rgba(0, 0, 0, 0.12)');
        root.style.setProperty('--asset-card-border', '#e2e8f0');
        root.style.setProperty('--asset-card-border-hover', '#cbd5e1');
        root.style.setProperty('--asset-button-primary-bg', 'rgba(59, 130, 246, 0.05)');
        root.style.setProperty('--asset-button-primary-border', '#3b82f6');
        root.style.setProperty('--asset-button-primary-text', '#3b82f6');
        root.style.setProperty('--asset-button-primary-hover-bg', 'rgba(59, 130, 246, 0.1)');
        root.style.setProperty('--asset-button-primary-hover-border', '#2563eb');
        root.style.setProperty('--asset-button-primary-hover-text', '#2563eb');
        root.style.setProperty('--asset-button-secondary-bg', 'rgba(99, 102, 241, 0.05)');
        root.style.setProperty('--asset-button-secondary-border', '#6366f1');
        root.style.setProperty('--asset-button-secondary-text', '#6366f1');
        root.style.setProperty('--asset-button-secondary-hover-bg', 'rgba(99, 102, 241, 0.1)');
        root.style.setProperty('--asset-button-secondary-hover-border', '#4f46e5');
        root.style.setProperty('--asset-button-secondary-hover-text', '#4f46e5');
        root.style.setProperty('--asset-delete-warning-bg-primary', '#f8fafc');
        root.style.setProperty('--asset-delete-warning-bg-secondary', '#f1f5f9');
        ...
        root.style.setProperty('--settings-popup-shadow', 'rgba(0, 0, 0, 0.15)');
        ...
        root.style.setProperty('--settings-button-primary-bg', 'rgba(59, 130, 246, 0.05)');
        root.style.setProperty('--settings-button-primary-border', '#3b82f6');
